export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      fetchUpstreamModels: 'Fetch models from upstream',
      fetchingUpstreamModels: 'Fetching...',
      fetchUpstreamModelsHint: 'Load available upstream models using current Base URL and API key',
      fetchUpstreamModelsSuccess: 'Fetched {count} model(s) from upstream',
      noUpstreamModelsFound: 'No models returned from upstream',
      ...
      mappingRowIncomplete: 'Row {line} is incomplete. Please fill both request and target models.',
      mappingDuplicateFromRow: 'Row {line} has duplicate request model {model}. Keep only one mapping.',
      whitelistWildcardNotSupported: 'Whitelist row {line} model {model} cannot contain wildcard *',
      wildcardOnlyAtEnd: 'Wildcard * can only be at the end',
      wildcardOnlyAtEndRow: 'Row {line} request model wildcard * can only be at the end',
      targetNoWildcard: 'Target model cannot contain wildcard *',
      targetNoWildcardRow: 'Row {line} target model cannot contain wildcard *',
